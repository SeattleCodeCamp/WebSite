...
{
    public class TimeslotsViewModel:ViewModelBase
    {
        DataServiceCollection<Timeslot> timeslots = new DataServiceCollection<Timeslot>();
        ...
        public void Load()
        {
            timeslots = App.MainViewModel.Timeslots; 
